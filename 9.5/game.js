...
class playGame extends Phaser.Scene {
    ...
    create() {
        let deck = this.add.sprite(100, 150, "deck").setInteractive().on("pointerup",() => {
            var randNumber = Phaser.Math.Between(0, 51);
            this.createCard(randNumber),
        ...
        for(let i = 0; i < 5; i++) {
            for(let j = 0; j < 3; j++) {
                let blank = this.add.sprite(400 + 100 * i, 150 + 100 * j, "blank").setInteractive();
        ...
        // set a drop zone
        this.zone = this.add.zone(650, 460, 800, 200); // x, y, width, height
        this.zone.setRectangleDropZone(800, 200); // width, height
